...
// GetBoolean gets the boolean property value. The boolean property
func (m *ColumnDefinition) GetBoolean()(BooleanColumnable) {
    return m.boolean
}
// GetCalculated gets the calculated property value. The calculated property
func (m *ColumnDefinition) GetCalculated()(CalculatedColumnable) {
    return m.calculated
}
// GetChoice gets the choice property value. The choice property
...
// GetContentApprovalStatus gets the contentApprovalStatus property value. The contentApprovalStatus property
...
// GetGeolocation gets the geolocation property value. The geolocation property
...
// GetHyperlinkOrPicture gets the hyperlinkOrPicture property value. The hyperlinkOrPicture property
...
// GetLookup gets the lookup property value. The lookup property
...
// GetPersonOrGroup gets the personOrGroup property value. The personOrGroup property
...
// GetSourceColumn gets the sourceColumn property value. The sourceColumn property
func (m *ColumnDefinition) GetSourceColumn()(ColumnDefinitionable) {
    return m.sourceColumn
}
// GetSourceContentType gets the sourceContentType property value. The sourceContentType property
...
// GetValidation gets the validation property value. The validation property
...
// SetBoolean sets the boolean property value. The boolean property
func (m *ColumnDefinition) SetBoolean(value BooleanColumnable)() {
    m.boolean = value
}
// SetCalculated sets the calculated property value. The calculated property
func (m *ColumnDefinition) SetCalculated(value CalculatedColumnable)() {
    m.calculated = value
}
// SetChoice sets the choice property value. The choice property
...
// SetContentApprovalStatus sets the contentApprovalStatus property value. The contentApprovalStatus property
...
// SetGeolocation sets the geolocation property value. The geolocation property
...
// SetHyperlinkOrPicture sets the hyperlinkOrPicture property value. The hyperlinkOrPicture property
...
// SetLookup sets the lookup property value. The lookup property
...
// SetPersonOrGroup sets the personOrGroup property value. The personOrGroup property
...
// SetSourceColumn sets the sourceColumn property value. The sourceColumn property
func (m *ColumnDefinition) SetSourceColumn(value ColumnDefinitionable)() {
    m.sourceColumn = value
}
// SetSourceContentType sets the sourceContentType property value. The sourceContentType property
...
// SetValidation sets the validation property value. The validation property
