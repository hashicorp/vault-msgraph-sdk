...
// GetConfigurationManagerClientEnabledFeatures gets the configurationManagerClientEnabledFeatures property value. configuration Manager client enabled features
...
// GetDeviceHealthAttestationState gets the deviceHealthAttestationState property value. The deviceHealthAttestationState property
...
// GetWindowsProtectionState gets the windowsProtectionState property value. The windowsProtectionState property
...
// SetConfigurationManagerClientEnabledFeatures sets the configurationManagerClientEnabledFeatures property value. configuration Manager client enabled features
...
// SetDeviceHealthAttestationState sets the deviceHealthAttestationState property value. The deviceHealthAttestationState property
...
// SetWindowsProtectionState sets the windowsProtectionState property value. The windowsProtectionState property
