...
// GetCategoryAxis gets the categoryAxis property value. The categoryAxis property
...
// GetSeriesAxis gets the seriesAxis property value. The seriesAxis property
func (m *WorkbookChartAxes) GetSeriesAxis()(WorkbookChartAxisable) {
    return m.seriesAxis
}
// GetValueAxis gets the valueAxis property value. The valueAxis property
...
// SetCategoryAxis sets the categoryAxis property value. The categoryAxis property
func (m *WorkbookChartAxes) SetCategoryAxis(value WorkbookChartAxisable)() {
    m.categoryAxis = value
}
// SetSeriesAxis sets the seriesAxis property value. The seriesAxis property
func (m *WorkbookChartAxes) SetSeriesAxis(value WorkbookChartAxisable)() {
    m.seriesAxis = value
}
// SetValueAxis sets the valueAxis property value. The valueAxis property
