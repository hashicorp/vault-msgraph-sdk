...
// GetParentNotebook gets the parentNotebook property value. The parentNotebook property
func (m *SectionGroup) GetParentNotebook()(Notebookable) {
    return m.parentNotebook
}
// GetParentSectionGroup gets the parentSectionGroup property value. The parentSectionGroup property
...
// SetParentNotebook sets the parentNotebook property value. The parentNotebook property
func (m *SectionGroup) SetParentNotebook(value Notebookable)() {
    m.parentNotebook = value
}
// SetParentSectionGroup sets the parentSectionGroup property value. The parentSectionGroup property
