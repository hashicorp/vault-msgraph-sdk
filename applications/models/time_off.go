...
// GetDraftTimeOff gets the draftTimeOff property value. The draftTimeOff property
...
// GetSharedTimeOff gets the sharedTimeOff property value. The sharedTimeOff property
...
// SetDraftTimeOff sets the draftTimeOff property value. The draftTimeOff property
func (m *TimeOff) SetDraftTimeOff(value TimeOffItemable)() {
    m.draftTimeOff = value
}
// SetSharedTimeOff sets the sharedTimeOff property value. The sharedTimeOff property
