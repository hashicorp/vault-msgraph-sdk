...
// GetAxes gets the axes property value. The axes property
func (m *WorkbookChart) GetAxes()(WorkbookChartAxesable) {
    return m.axes
}
// GetDataLabels gets the dataLabels property value. The dataLabels property
...
// GetLegend gets the legend property value. The legend property
...
// GetWorksheet gets the worksheet property value. The worksheet property
...
// SetAxes sets the axes property value. The axes property
func (m *WorkbookChart) SetAxes(value WorkbookChartAxesable)() {
    m.axes = value
}
// SetDataLabels sets the dataLabels property value. The dataLabels property
...
// SetLegend sets the legend property value. The legend property
...
// SetWorksheet sets the worksheet property value. The worksheet property
