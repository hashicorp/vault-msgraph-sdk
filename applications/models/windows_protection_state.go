...
// GetDeviceState gets the deviceState property value. Computer endpoint protection state
...
// GetProductStatus gets the productStatus property value. Product Status of Windows Defender
...
// SetDeviceState sets the deviceState property value. Computer endpoint protection state
...
// SetProductStatus sets the productStatus property value. Product Status of Windows Defender
