...
// GetAttestationLevel gets the attestationLevel property value. The attestationLevel property
...
// SetAttestationLevel sets the attestationLevel property value. The attestationLevel property
