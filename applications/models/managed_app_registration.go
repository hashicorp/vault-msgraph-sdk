...
// GetAppIdentifier gets the appIdentifier property value. The identifier for a mobile app.
...
// SetAppIdentifier sets the appIdentifier property value. The identifier for a mobile app.
