...
// GetDocumentSet gets the documentSet property value. The documentSet property
func (m *ContentType) GetDocumentSet()(DocumentSetable) {
    return m.documentSet
}
// GetDocumentTemplate gets the documentTemplate property value. The documentTemplate property
...
// GetInheritedFrom gets the inheritedFrom property value. The inheritedFrom property
...
// SetDocumentSet sets the documentSet property value. The documentSet property
func (m *ContentType) SetDocumentSet(value DocumentSetable)() {
    m.documentSet = value
}
// SetDocumentTemplate sets the documentTemplate property value. The documentTemplate property
...
// SetInheritedFrom sets the inheritedFrom property value. The inheritedFrom property
