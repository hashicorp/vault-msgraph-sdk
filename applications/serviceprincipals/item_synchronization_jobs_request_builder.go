...
// ItemSynchronizationJobsRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs
...
// BySynchronizationJobId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.servicePrincipals.item.synchronization.jobs.item collection
