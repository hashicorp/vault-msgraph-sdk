...
// ItemMicrosoftGraphRemoveKeyRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\microsoft.graph.removeKey
...
func NewItemMicrosoftGraphRemoveKeyRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphRemoveKeyRequestBuilder) {
    m := &ItemMicrosoftGraphRemoveKeyRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.removeKey", pathParameters),
    }
    return m
}
...
func (m *ItemMicrosoftGraphRemoveKeyRequestBuilder) Post(ctx context.Context, body ItemMicrosoftGraphRemoveKeyRemoveKeyPostRequestBodyable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])([]byte, error) {
...
func (m *ItemMicrosoftGraphRemoveKeyRequestBuilder) WithUrl(rawUrl string)(*ItemMicrosoftGraphRemoveKeyRequestBuilder) {
    return NewItemMicrosoftGraphRemoveKeyRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
