...
// ItemOwnersItemMicrosoftGraphServicePrincipalRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\owners\{directoryObject-id}\microsoft.graph.servicePrincipal
...
func NewItemOwnersItemMicrosoftGraphServicePrincipalRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersItemMicrosoftGraphServicePrincipalRequestBuilder) {
    m := &ItemOwnersItemMicrosoftGraphServicePrincipalRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}", pathParameters),
    }
    return m
}
