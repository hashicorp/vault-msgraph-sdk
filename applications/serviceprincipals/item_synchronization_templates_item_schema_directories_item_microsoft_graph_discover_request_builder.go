...
// ItemSynchronizationTemplatesItemSchemaDirectoriesItemMicrosoftGraphDiscoverRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\templates\{synchronizationTemplate-id}\schema\directories\{directoryDefinition-id}\microsoft.graph.discover
...
func NewItemSynchronizationTemplatesItemSchemaDirectoriesItemMicrosoftGraphDiscoverRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationTemplatesItemSchemaDirectoriesItemMicrosoftGraphDiscoverRequestBuilder) {
    m := &ItemSynchronizationTemplatesItemSchemaDirectoriesItemMicrosoftGraphDiscoverRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories/{directoryDefinition%2Did}/microsoft.graph.discover", pathParameters),
    }
    return m
}
