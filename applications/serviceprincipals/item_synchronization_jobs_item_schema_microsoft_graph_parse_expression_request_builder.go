...
// ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs\{synchronizationJob-id}\schema\microsoft.graph.parseExpression
...
func NewItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder) {
    m := &ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/microsoft.graph.parseExpression", pathParameters),
    }
    return m
}
...
func (m *ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder) WithUrl(rawUrl string)(*ItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder) {
    return NewItemSynchronizationJobsItemSchemaMicrosoftGraphParseExpressionRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
