...
// ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\ownedObjects\microsoft.graph.endpoint
...
func NewItemOwnedObjectsMicrosoftGraphEndpointRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) {
    m := &ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
func (m *ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) Count()(*ItemOwnedObjectsMicrosoftGraphEndpointCountRequestBuilder) {
    return NewItemOwnedObjectsMicrosoftGraphEndpointCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get get the items of type microsoft.graph.endpoint in the microsoft.graph.directoryObject collection
func (m *ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilderGetQueryParameters])(i39f8001d2b9b38b5cf71c15d33bad53f1b997f356b85cb9fd9fee820940d88bc.EndpointCollectionResponseable, error) {
...
func (m *ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilderGetQueryParameters])(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) WithUrl(rawUrl string)(*ItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder) {
    return NewItemOwnedObjectsMicrosoftGraphEndpointRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
