...
// ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\owners\microsoft.graph.appRoleAssignment
...
func NewItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) {
    m := &ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters),
    }
    return m
}
...
func NewItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) {
    ...
    return NewItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilderInternal(urlParams, requestAdapter)
}
// Count the Count property
func (m *ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) Count()(*ItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilder) {
    return NewItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
// Get get the items of type microsoft.graph.appRoleAssignment in the microsoft.graph.directoryObject collection
func (m *ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilderGetQueryParameters])(i39f8001d2b9b38b5cf71c15d33bad53f1b997f356b85cb9fd9fee820940d88bc.AppRoleAssignmentCollectionResponseable, error) {
...
func (m *ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilderGetQueryParameters])(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
func (m *ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) WithUrl(rawUrl string)(*ItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder) {
    return NewItemOwnersMicrosoftGraphAppRoleAssignmentRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
