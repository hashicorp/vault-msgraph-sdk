...
// ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder builds and executes requests for operations under \servicePrincipals\{servicePrincipal-id}\synchronization\jobs\microsoft.graph.validateCredentials
...
func NewItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder) {
    m := &ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/microsoft.graph.validateCredentials", pathParameters),
    }
    return m
}
...
func (m *ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder) WithUrl(rawUrl string)(*ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder) {
    return NewItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
