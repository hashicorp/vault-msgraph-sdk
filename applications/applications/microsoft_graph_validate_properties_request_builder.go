...
// MicrosoftGraphValidatePropertiesRequestBuilder builds and executes requests for operations under \applications\microsoft.graph.validateProperties
...
func NewMicrosoftGraphValidatePropertiesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*MicrosoftGraphValidatePropertiesRequestBuilder) {
    m := &MicrosoftGraphValidatePropertiesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/microsoft.graph.validateProperties", pathParameters),
    }
    return m
}
