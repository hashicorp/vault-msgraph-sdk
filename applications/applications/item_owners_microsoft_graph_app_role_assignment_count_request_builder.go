...
// ItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilder builds and executes requests for operations under \applications\{application-id}\owners\microsoft.graph.appRoleAssignment\$count
...
func NewItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilder) {
    m := &ItemOwnersMicrosoftGraphAppRoleAssignmentCountRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/owners/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}", pathParameters),
    }
    return m
}
