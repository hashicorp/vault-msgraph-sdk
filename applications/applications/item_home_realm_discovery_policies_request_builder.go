...
// ItemHomeRealmDiscoveryPoliciesRequestBuilder builds and executes requests for operations under \applications\{application-id}\homeRealmDiscoveryPolicies
...
// ByHomeRealmDiscoveryPolicyId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.homeRealmDiscoveryPolicies.item collection
