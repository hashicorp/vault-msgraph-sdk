...
// ItemTokenIssuancePoliciesRequestBuilder builds and executes requests for operations under \applications\{application-id}\tokenIssuancePolicies
...
// ByTokenIssuancePolicyId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.tokenIssuancePolicies.item collection
