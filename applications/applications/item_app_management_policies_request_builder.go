...
// ItemAppManagementPoliciesRequestBuilder builds and executes requests for operations under \applications\{application-id}\appManagementPolicies
...
// ByAppManagementPolicyId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.appManagementPolicies.item collection
