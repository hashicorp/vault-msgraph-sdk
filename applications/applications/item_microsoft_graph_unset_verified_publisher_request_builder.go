...
// ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder builds and executes requests for operations under \applications\{application-id}\microsoft.graph.unsetVerifiedPublisher
...
func NewItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder) {
    m := &ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/microsoft.graph.unsetVerifiedPublisher", pathParameters),
    }
    return m
}
...
func (m *ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder) Post(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])([]byte, error) {
...
func (m *ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder) WithUrl(rawUrl string)(*ItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder) {
    return NewItemMicrosoftGraphUnsetVerifiedPublisherRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
