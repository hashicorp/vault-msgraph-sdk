...
// ItemTokenLifetimePoliciesRequestBuilder builds and executes requests for operations under \applications\{application-id}\tokenLifetimePolicies
...
// ByTokenLifetimePolicyId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.tokenLifetimePolicies.item collection
