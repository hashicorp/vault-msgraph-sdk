...
// ItemOwnersItemMicrosoftGraphAppRoleAssignmentRequestBuilder builds and executes requests for operations under \applications\{application-id}\owners\{directoryObject-id}\microsoft.graph.appRoleAssignment
...
func NewItemOwnersItemMicrosoftGraphAppRoleAssignmentRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersItemMicrosoftGraphAppRoleAssignmentRequestBuilder) {
    m := &ItemOwnersItemMicrosoftGraphAppRoleAssignmentRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/owners/{directoryObject%2Did}/microsoft.graph.appRoleAssignment{?%24select,%24expand}", pathParameters),
    }
    return m
}
