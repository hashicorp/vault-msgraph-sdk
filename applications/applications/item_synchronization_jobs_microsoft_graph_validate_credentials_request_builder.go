...
// ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder builds and executes requests for operations under \applications\{application-id}\synchronization\jobs\microsoft.graph.validateCredentials
...
func NewItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder) {
    m := &ItemSynchronizationJobsMicrosoftGraphValidateCredentialsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/microsoft.graph.validateCredentials", pathParameters),
    }
    return m
}
