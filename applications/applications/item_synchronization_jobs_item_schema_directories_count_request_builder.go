...
// ItemSynchronizationJobsItemSchemaDirectoriesCountRequestBuilder builds and executes requests for operations under \applications\{application-id}\synchronization\jobs\{synchronizationJob-id}\schema\directories\$count
