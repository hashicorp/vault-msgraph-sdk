...
// ItemOwnersRequestBuilder builds and executes requests for operations under \applications\{application-id}\owners
...
// ByDirectoryObjectId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.owners.item collection
