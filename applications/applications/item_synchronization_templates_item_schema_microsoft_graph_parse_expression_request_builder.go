...
// ItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionRequestBuilder builds and executes requests for operations under \applications\{application-id}\synchronization\templates\{synchronizationTemplate-id}\schema\microsoft.graph.parseExpression
...
func NewItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionRequestBuilder) {
    m := &ItemSynchronizationTemplatesItemSchemaMicrosoftGraphParseExpressionRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/microsoft.graph.parseExpression", pathParameters),
    }
    return m
}
