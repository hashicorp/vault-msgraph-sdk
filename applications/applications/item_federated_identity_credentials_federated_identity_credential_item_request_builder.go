...
// ItemFederatedIdentityCredentialsFederatedIdentityCredentialItemRequestBuilder builds and executes requests for operations under \applications\{application-id}\federatedIdentityCredentials\{federatedIdentityCredential-id}
