...
// ItemSynchronizationJobsItemSchemaDirectoriesRequestBuilder builds and executes requests for operations under \applications\{application-id}\synchronization\jobs\{synchronizationJob-id}\schema\directories
...
// ByDirectoryDefinitionId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.applications.item.synchronization.jobs.item.schema.directories.item collection
