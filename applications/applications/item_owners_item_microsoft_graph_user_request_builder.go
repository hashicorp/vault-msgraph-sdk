...
// ItemOwnersItemMicrosoftGraphUserRequestBuilder builds and executes requests for operations under \applications\{application-id}\owners\{directoryObject-id}\microsoft.graph.user
...
func NewItemOwnersItemMicrosoftGraphUserRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemOwnersItemMicrosoftGraphUserRequestBuilder) {
    m := &ItemOwnersItemMicrosoftGraphUserRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/applications/{application%2Did}/owners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}", pathParameters),
    }
    return m
}
