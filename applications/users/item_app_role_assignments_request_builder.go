...
// ItemAppRoleAssignmentsRequestBuilder builds and executes requests for operations under \users\{user-id}\appRoleAssignments
...
// ByAppRoleAssignmentId gets an item from the github.com/hashicorp/vault-msgraph-sdk/applications.users.item.appRoleAssignments.item collection
